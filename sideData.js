...
let VebDropItem1 = document.getElementById("VebDropItem1")
let DomenDropItem1 = document.getElementById("DomenDropItem1")
let HostinqDropItem1 = document.getElementById("HostinqDropItem1")
let XidDropItem1 = document.getElementById("XidDropItem1")
let CompDropItem1 = document.getElementById("CompDropItem1")
let dropCategories1 = [VebDropItem1, DomenDropItem1, HostinqDropItem1, XidDropItem1, CompDropItem1]
count1 = 0
dropCategories1.forEach((dropItem) => {
  navArray1[count1].forEach((item) => {
    dropItem.innerHTML +=
      `
